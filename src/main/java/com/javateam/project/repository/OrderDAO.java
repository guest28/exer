...
public class OrderDAO {
	 ...
	 * 주문 상세 내역 추가
	 * 
	 * @param cartVO 장바구니VO 객체
	 * @param maxOseq 최근 주문 번호
	...
	public List<OrderVO> listOrderById(String id, String result, int oseq) {	
		...
		return sqlSession.selectList(MAPPER_NS + "listOrderById", id);
	}
	...
	public List<Integer> selectSeqOrderIng(String id) {
		...
		log.info("OrderDAO.selectSeqOrderIng");
