...
<div id="main_img" class="carousel slide" data-bs-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="${contextPath}/img/main/main_1.png" class="d-block" style="width:100%">
		</div>		
		<div class="carousel-item">
			<img src="${contextPath}/img/main/main_5.png" class="d-block" style="width:100%">
		</div>
		<div class="carousel-item">
			<img src="${contextPath}/img/main/main_3.png" class="d-block" style="width:100%">
		</div>
		<div class="carousel-item">
			<img src="${contextPath}/img/main/main_4.png" class="d-block" style="width:100%">
		</div>
	</div>
		  
	<!-- Left and right controls/icons -->
	<button class="carousel-control-prev" type="button" data-bs-target="#main_img" data-bs-slide="prev">
		<span class="material-icons" style="color:black; opacity:0.7; font-size:6em; font-weight:bold">arrow_back_ios</span>
	</button>
			  
	<button class="carousel-control-next" type="button" data-bs-target="#main_img" data-bs-slide="next">
		<span class="material-icons" style="color:black; opacity:0.7; font-size:6em; font-weight:bold">arrow_forward_ios</span>
	</button>		  
</div>
<!--메인 이미지 들어가는 곳 끝-->
	...
	<div id="newProduct">   		
		<c:forEach var="i" begin="0" end="3">
			<div id="newItem${i}">
				...
				<!-- 상품이 있을 경우 -->
				<c:if test="${not empty newProductList[i].name}">				
					<a href="${contextPath}/product/product_detail?pseq=${newProductList[i].pseq}">									
						...
						<h6>${newProductList[i].name}</h6>
		          		...
		          		<p><fmt:formatNumber maxFractionDigits="3" value="${newProductList[i].price1}" /> 원</p>
					</a>
		         </c:if>
		         
		         <!-- 상품이 없을 경우 -->
		         <c:if test="${empty newProductList[i].name}">
						<img src="<%=request.getContextPath() %>/img/blank_X.jpg" />
				...
				<c:if test="${not empty bestProductList[i].name}">
					<a href="${contextPath}/product/product_detail?pseq=${bestProductList[i].pseq}">
						...
						<h6>${bestProductList[i].name}</h6>
		          		...
		          		<p><fmt:formatNumber maxFractionDigits="3" value="${bestProductList[i].price1}" /> 원</p>				
					</a>
		         </c:if>
