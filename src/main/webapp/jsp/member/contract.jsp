...
(3) 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.
      ...
      <br><br>
		...
		<input type="button" value="Next" class="btn btn-outline-secondary" onclick="go_next()" id="goNextBtn" style="float: right;">
...
<!-- <script>
	$('#goNextBtn').click(function(){
		location.href = "/project/member/movePageTest.do"
	});
</script> -->
