...
window.onload = function() {
	...
	for(var i = 0; i < useynSelectBoxes.length; i++) {
		...
		useynSelectBoxId = useynSelectBoxes[i];
		...
		cosole.log("pseq init val : " + pseqVal)
	...
	for(var i = 0; i < bestynSelectBoxes.length; i++) {
		...
		bestynSelectBoxId = bestynSelectBoxes[i];
	...
	for (var useynSelectBox of useynSelectBoxs) {
	...
	for (var bestynSelectBox of bestynSelectBoxs) {
