...
<%@ include file="product_head.jsp" %>
		...
		<article id="product_list_section">
			...
			<div id="product_list_pnl" style="width:1300px;" class="my-3 pb-3">
				...
				<form action="${contextPath}/admin/product/searchProductList">
				...
				<div id="product_list_head" class="row my-5">
					...
					<div class="col-2 justify-content-center">
						<select id="search_field" name="search_field" class="form-control">
							...
							<option value="Shcakers">Shcakers</option>
						...
						<tbody>
							...
							<c:forEach var="product" items="${products}" varStatus="st">
								<tr>
									...
									<!-- 상품 이미지 -->
									<td>
										<a href="${contextPath}/admin/product/productDetail?pseq=${product.pseq}&page=${pageVO.currPage}"></a>
									...
									<!-- 상품명 -->
									<td>
										<a href="${contextPath}/admin/product/productDetail?pseq=${product.pseq}&page=${pageVO.currPage}">${product.name}</a>
										</td>
